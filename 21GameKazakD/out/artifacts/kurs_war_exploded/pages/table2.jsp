...
<head>
    ...
    <script type="text/javascript" src="../scripts/table2.js"></script>
...
<div id="myCardPane" class="cardPane">
    <fieldset class="inner" id="secondPlayer">
        <legend id="secondLegend"></legend>
    </fieldset>

    <fieldset class="inner" id="firstPlayer">
        <legend id="firstLegend"></legend>
    </fieldset>
</div>
<div class="commandPane">
    <div class="buttonPane">
        <div class="inner">
            <button id="deal" type="button" onclick="deal2()"><fmt:message key="table.control.deal"/></button>
        </div>
        <div class="inner">
            <button id="hit" type="button" onclick="hit2()"><fmt:message key="table.control.hit"/></button>
        </div>
        ...
        <div class="inner">
            <button id="stand" type="button" onclick="stand2()"><fmt:message key="table.control.stand"/></button>
        </div>
    </div>
    <div id="tokenForm" class="tokenForm">
        <div>
            <input id="token1" class="token" type="button" value="1" onclick="bet2(1)">
        </div>
        <div>
            <input id="token5" class="token" type="button" value="5" onclick="bet2(5)">
        </div>
        <div>
            <input id="token10" class="token" type="button" value="10" onclick="bet2(10)">
        </div>
        <div>
            <input id="token50" class="token" type="button" value="50" onclick="bet2(50)">
        </div>
        <div>
            <input id="token100" class="token" type="button" value="100" onclick="bet2(100)">
        </div>
        <div>
            <input id="token500" class="token" type="button" value="500" onclick="bet2(500)">
        </div>
    </div>
...
<div id="waitModal" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            <h2><fmt:message key="waitModal.label.title"/></h2>
        </div>
        <div class="modal-body">
            <fmt:message key="waitModal.label.info"/>
        </div>
        <div class="modal-footer">
        </div>
    </div>
